              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                  <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                    <div style="display:flex; align-items:center; margin-bottom: 10px"><img src="https://res.cloudinary.com/ds6hdw753/image/upload/v1701836038/csiz1utjcjcvijz81rrj.png" alt="Logo" border="0" width="24px" style="display: block; width: 24px; max-width: 24px; height: 24px; min-width: 24px;"><h4 style="font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-weight: 900; margin: 0 0 0 5px; font-size: 20px; color: #ae65e4">BEEMAIL</h4></div>
